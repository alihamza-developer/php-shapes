...
{
    global $width, $height, $FILL_PATH_GAP, $size, $FILL_P_STROKE_COLOR, $FILL_P_STROKE_WIDTH, $STROKE_COLOR, $STROKE_WIDTH;

    $is_pdf = ($type === 'pdf');
    $path = get_resized_path($width, $height);

    $f_width = $width - ($FILL_PATH_GAP + $size + 100);
    $f_height = $height - ($FILL_PATH_GAP + $size + 100);
